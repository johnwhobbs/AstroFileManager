...
def calculate_metrics_from_data(data) -> Dict[str, Optional[float]]:
    ...
    try:
        ...
        # star ('roundness1' and 'roundness2'). We average their magnitudes
        # across all stars to summarize how round the stars are overall.
        roundness_values = []
        ...
        if roundness_values:
            ...
            metrics["star_roundness"] = float(np.mean(combined_roundness))
